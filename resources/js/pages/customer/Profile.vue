  ...
  <div class="p-6 md:p-8 space-y-8">
    <div class="profile-header flex flex-col md:flex-row md:items-center justify-between gap-6">
      <div class="profile-title">
        ...
        <p class="text-white/60 font-medium">Welcome, <strong class="text-indigo-400">{{ username }}</strong>. Manage your purchases quickly.</p>
      </div>
    ...
    <GlassCard customClass="p-8 border-white/10 shadow-2xl">
      <div class="purchases-header flex items-center justify-between mb-8">
        <h3 class="text-2xl font-bold text-white flex items-center gap-3">
          <ShoppingBag class="w-7 h-7 text-indigo-400" />
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <router-link 
          ...
          class="group relative flex items-center justify-between p-6 bg-white/5 border border-white/10 rounded-3xl hover:bg-white/10 hover:border-indigo-500/40 transition-all overflow-hidden"
        >
          ...
          <div class="flex items-center gap-4">
            <div class="w-12 h-12 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center">
              <component :is="badge.icon" class="w-6 h-6 text-indigo-400" />
            </div>
            <div>
