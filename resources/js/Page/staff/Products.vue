<template>
  <StaffLayout :username="username">
    <div class="space-y-6">
      <div class="header flex flex-col md:flex-row md:items-center justify-between gap-3">
        <div>
              ...
              <tr v-if="filteredProducts.length === 0">
                <td colspan="6" class="px-6 py-32 text-center">
                  <div class="flex flex-col items-center gap-4 opacity-10">
                    <Ghost class="w-16 h-16" />
                    <p class="font-bold text-lg italic">No products found.</p>
                  </div>
                </td>
              </tr>
            </tbody>
...
import { ChevronLeft, Search, Fish, Ghost } from 'lucide-vue-next';
