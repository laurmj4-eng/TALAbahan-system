        ...
        if (!window.FIREBASE_CONFIG || !window.FIREBASE_CONFIG.apiKey) {
            ...
            onAuthStateChanged(auth, (user) => {
                if (user) {
                    ...
                    statusEl.innerHTML = `
                        <p style="margin-bottom: 20px; font-size: 16px; color: #ccc;">Please continue to Google to sign in securely.</p>
                        <button id="googleBtn" style="
                            display: flex; align-items: center; justify-content: center; gap: 10px;
                            width: 100%; max-width: 300px; margin: 0 auto;
                            background: white; color: #333; border: none; border-radius: 12px;
                            padding: 12px 20px; font-weight: bold; font-size: 16px; cursor: pointer;
                        ...
                        <p id="errorMsg" style="color: #ef4444; margin-top: 15px; font-size: 14px;"></p>
                    `;
